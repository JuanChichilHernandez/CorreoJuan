...
{
    [Activity(Label = "EnviarCorreo.NativoChichil", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        Button actionButton;
        string emailBase = "juan.chichilhernandez@outlook.com";
        ...
        private async void btnReportar_Click(object sender, EventArgs e)
        {
            ...
            if (emailBase == "juan.chichilhernandez@outlook.com" || codeBase == "iniciativa")
            {
